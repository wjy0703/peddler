...
@Component
public class XhJksqcompanyDownrelatedDao extends HibernateDao<XhJksqcompanyDownrelated, Long>{

	public Page<XhJksqcompanyDownrelated> queryXhJksqcompanyDownrelated(Page<XhJksqcompanyDownrelated> page, Map<String, Object> params){
		String hql = "from XhJksqcompanyDownrelated xhJksqcompanyDownrelated where 1=1";
		//公司名称
