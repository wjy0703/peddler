package cn.com.cucsi.app.excel.utils;
...
//        test.saveFile("D:\\timesheet2.xls");
	...
	private void createBaseInfoTwo(XhJksq xhJksq) {
    	 specialXLS.createBaseInfo(data_two);	
	}

	 private void createBaseInfoThree(XhJksq xhJksq) {
	    	specialXLS.createBaseInfo(data_three);	
			
		}
	 
	private void createBaseInfoFour(XhJksq xhJksq) {
		specialXLS.createBaseInfo(data_four);	
	}
	 
	private void createBaseInfoFive(XhJksq xhJksq) {
			
		specialXLS.createBaseInfo(data_five);	
	}

	private void createBaseInfoSix(XhJksq xhJksq) {
		specialXLS.createBaseInfo(data_six);	
	}

	private void createBaseInfoSeven(XhJksq xhJksq) {
		specialXLS.createBaseInfo(data_seven);	
	}
	
	private void createBaseInfoEight(XhJksq xhJksq) {
		specialXLS.createBaseInfo(data_eight);	
		
	}

	private void createBaseInfoNine(XhJksq xhJksq) {
		specialXLS.createBaseInfo(data_nine);	
		
	}

	private void createBaseInfoTen(XhJksq xhJksq) {
		specialXLS.createBaseInfo(data_ten);	
		
	}
	
	private void createBaseInfoEleven(XhJksq xhJksq) {
		specialXLS.createBaseInfo(data_eleven);	
		
	}

	private void createBaseInfoTwelve(XhJksq xhJksq) {
		specialXLS.createBaseInfo(data_twelve);	
		
	}

	private void createBaseInfoThirteen(XhJksq xhJksq) {
		specialXLS.createBaseInfo(data_thirteen);	
		
	}

	private void createBaseInfoFourteen(XhJksq xhJksq) {
		specialXLS.createBaseInfo(data_fourteen);	
		
	}
	
	private void createBaseInfoFifteen(XhJksq xhJksq) {
		specialXLS.createBaseInfo(data_fifteen);	
    ...
    private  void createBaseEmptyInfoOne(XhJksq xhJksq) {
        for(int index = 0 ; index< 10 ; index++){
            specialXLS.createBaseInfo(empty_data);
            setCellValue(0,1,"12");
            setCellValue(0,2,"值");
            setCellValue(0,3,"值大大");
        }
    }

    private  void createBaseInfoOne(XhJksq xhJksq) {
    ...
    public void generateFile(XhJksq xhJksq, String filePath) {
         specialXLS = new GenerateSpecialXLS("审批表");
         specialXLS.createHeader();
         createBaseInfoOne(xhJksq);
         createBaseInfoTwo(xhJksq);
         createBaseInfoThree(xhJksq);
         createBaseInfoFour(xhJksq);
         createBaseInfoFive(xhJksq);
         createBaseInfoSix(xhJksq);
         createBaseInfoSeven(xhJksq);
         createBaseInfoEight(xhJksq);
         createBaseInfoNine(xhJksq);
         createBaseInfoTen(xhJksq);
         createBaseInfoEleven(xhJksq);
         createBaseInfoTwelve(xhJksq);
         createBaseInfoThirteen(xhJksq);
         createBaseInfoFourteen(xhJksq);
         createBaseInfoFifteen(xhJksq);
         createBaseEmptyInfoOne(xhJksq);
         setStyle();
         saveFile(filePath);
    }
