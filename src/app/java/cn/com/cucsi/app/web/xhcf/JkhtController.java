...
@Controller
@RequestMapping(value="/jkht")
public class JkhtController {
...
//		String loginName = SpringSecurityUtils.getCurrentUserName();
	 ...
	 * @return
	 */
	@RequestMapping(value="/addJkht", method=RequestMethod.GET)
	public ModelAndView addJkht(HttpServletRequest request){
		List<City> province = baseInfoManager.getSuggestCity("0");
		request.setAttribute("province", province);
		...
		return new ModelAndView("jkht/jkhtInput", "dkrxx", new XhJkrxx());
	}
...
//		String loginName = SpringSecurityUtils.getCurrentUserName();
	 ...
	 * @return
	 */
	@RequestMapping(value="/viewJkht", method=RequestMethod.GET)
	public String viewJkht(Model model,HttpServletRequest request){
		String repFileUrl = request.getParameter("repFileUrl");
		model.addAttribute("repFileUrl", "a");
		return "jkht/swfPaper";
	}
