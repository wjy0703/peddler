 ...
 * 
 * $Id: JaxbBinder.java 1141 2010-07-31 17:54:22Z calvinxiu $
 */
package cn.com.peddler.extension.binder;
...
public class JaxbBinder {
	...
	@SuppressWarnings("unchecked")
	public <T> T fromXml(java.io.InputStream stream) {
		try {
			return (T) getUnmarshaller().unmarshal(stream);
		} catch (JAXBException e) {
			throw new RuntimeException(e);
		}
	}
