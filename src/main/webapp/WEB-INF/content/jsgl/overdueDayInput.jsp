...
<div class="pageContent">
		...
		<form method="post" action="${ctx}/xhCapitalOverdue/saveOverdueDay"
		...
		<div class="pageFormContent" layoutH="56">
			<p>
				<label>逾期天数：</label>
				<input name="spareField02" type="text" size="30" value="${xhCapitalOverdue.spareField02}" maxlength="256" min="1"/>
			</p>
			<p>
				<label>银行名称：</label>
