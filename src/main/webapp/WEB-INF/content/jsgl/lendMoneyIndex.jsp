...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);"
		action="${ctx }/lend/listLendMoney" method="post">
				...
				<tr>
					<td><label>CCA:</label> <input type="hidden" name=""
						...
						href="${ctx }/baseinfo/emplookup" lookupGroup="employeeCca"><hi:text
								key="查找带回" /></a></td>
					<td><label>账单日:</label> <select class="combox"
						name="filter_ztFlag">
	...
	<table class="table" width="100%" layoutH="130">
		...
		<tbody>
			<tr target="sid_user" rel="${user.id}">
				...
				<td></td>
				<td>否</td>
				<td><a title="查看月报" target="navTab"
					href="${ctx }/lend/lookLendMoney/${user.id}">查看月报</a></td>
			</tr>
		</tbody>
	</table>
	<div class="panelBar">
