...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);"
		...
		<div class="pageFormContent">
			<table>
				<tr>
					<td><label>借款编码:</label> <input type="text" name=""
						size="30" /></td>
					<td><label>借款人姓名:</label> <input type="text"
						name="" size="30" /></td>
					<td><label>日期:</label> <input type="text" name=""
						class="date" pattern="yyyy-MM" value="${cjrxx.csrq }" size="10" />~
					</td>
					<td><input type="text" name="" class="date"
		...
		<tbody>
			<!--  <tr target="sid_user" rel="${user.id}">
				...
				<td><a title="查看" target="navTab"
					href="${ctx }/dead/lookOverDate/${user.id}">查看</a> <a title="撤销"
					target="navTab" href="${ctx }/dead/revoDeadAccount/${user.id}">撤销</a>
				</td>-->
			</tr>
		</tbody>
	</table>
