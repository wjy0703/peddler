...
<div class="pageContent">
		...
		<form method="post" action="${ctx}/xhCapitalOverdue/saveOffsetOverdue"
		...
		<div class="pageFormContent" layoutH="56">
			<p>
				<label>冲抵金额：</label>
				<input name="spareField06" type="text" size="30" value="${money}" class="required number" maxlength="256" />
			</p>
			<p>
				<label>冲抵期数：</label>
				<input name="spareField05" type="text" size="30" value="1" class="required number" maxlength="256" />
			</p>
			<p>
				<label>银行名称：</label>
