...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);"
		action="${ctx }/xhTzsq/listChangeAuditTzsq" method="post">
			...
			<table>
				<tr>
					...
					<td><label>所在城市：</label> <select class="combox"
						name="filter_province" ref="combox_listChAuditXhTzsqcity"
						...
						id="combox_listChAuditXhTzsqcity">
			...
			<c:forEach items="${listTzsq}" var="user" varStatus="st">
				<tr target="sid_user" rel="${user.ID}">
					...
					<a title="查看" target="navTab"
		             ...
		             <div class="buttonActive">
				            <div class="buttonContent">
						<a title="变更审批" target="navTab"
						href="${ctx }/xhTzsq/changeAuditTzsq/${user.ID}">变更审批</a>
						</div>
		             </div>
		             </td>
				</tr>
