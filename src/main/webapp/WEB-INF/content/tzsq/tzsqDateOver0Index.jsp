...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);"
		action="${ctx }/xhTzsq/listTzsqDateRealyOver" method="post">
		<div class="searchBar">
			<table width="100%">
				<tr>
				...
				<td><label>出借金额：</label> <input 
					...
					<td><label>到期日期：</label> <%-- <input 
						name="filter_jhjsrqMin" value="${map.jhjsrqMin }" type="text" size="8" class="date">
					至
					<input  name="filter_jhjsrqMax"
						value="${map.jhjsrqMax }" type="text" size="8" class="date"></td>
					 --%>
					 <input name="filter_yesterday" value="${map.yesterday }" type="text" size="8" class="date" />
					 </td>
					<td>
						<div class="subBar">
							<ul>
...
<div class="pageContent">
	...
	<bjdv:validateContent type="1" funcId="投资申请-导出回款明细">	
		<ul class="toolBar">
			<li><a class="icon" href="${ctx}/xhTzsq/downTzsqDateOver/0"
