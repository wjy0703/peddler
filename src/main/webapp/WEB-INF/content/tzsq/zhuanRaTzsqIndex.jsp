...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);"
		action="${ctx }/tzsq/listZhuanRaTzsq" method="post">
		<div class="searchBar">
			<table>
				<tr>
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="${ctx}/tzsq/zhuanRaTzsq"
				target="navTab"><span>新增债权转让申请</span></a></li>
			<li><a title="确实要删除这些记录吗?" target="selectedTodo" rel="ids"
				postType="string" href="${ctx }/cjrxx/batchDelCjrxx" class="delete"
