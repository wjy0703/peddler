...
<div class="pageContent">
	<form method="post" action="${ctx}/xhCarLoanDeduct/saveXhCarLoanDeduct" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
		...
		<div class="panel" align="center">
			...
			<div class="panel" align="center">
				...
				<td>
					<label>中间人：</label>
					<input type="hidden"
					class="textInput" name="middleMan.id" size="10" value="${xhCarLoanContract.middleMan.id}"
					 maxlength="22" /> <input type="text"
					class="textInput" name="middleMan.middleManName" size="10"
					value="${xhCarLoanContract.middleMan.middleManName}"  class="required"
						...
						<tbody>
							<tr>
							   <td>
							      ...
							      <td > 
							      <input type="radio" name="opt"  class="required" value="60"> 通过
								  <input type="radio" name="opt"  class="required" value="519"> 不通过 
							   </td>
							   <td>
							      <label>审核说明：</label>
							   </td>
							   <td >
									<input name="remark" value="" size="50"/>
							   </td>
							</tr>
						</tbody>
					</table>
