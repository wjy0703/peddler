...
<div class="pageContent">
	<form method="post" action="${ctx}/xhCarLoanApply/saveXhCarLoanApply" class="pageForm required-validate" onsubmit="return submitApply(this);">
						...
						<tbody>
							<tr height="30px">
								...
								<td><input type="text" id="userName" disabled="disabled" name="userName" value="${xhCarLoanApply.xhCarLoanUser.userName }" class=""> <input type="hidden" name="xhCarLoanUser.id"
									size="30" value="${xhCarLoanApply.xhCarLoanUser.id}" /> <input type="hidden" name="id" value="${xhCarLoanApply.id}" /> 
							...
							<tr>
								...
								<td colspan="3"><%-- <input type="text" id="liveState" disabled="disabled" name="liveState" size="30" value="${xhCarLoanApply.xhCarLoanUser.liveState }" class=""> --%>
									<sen:selectRadio name="liveState" value="${xhCarLoanApply.xhCarLoanUser.liveState }" split="&nbsp;&nbsp;&nbsp;&nbsp;"  coding="car_livestate"/>
								</td>
							</tr>
						</tbody>
					</table>
					...
					<table class="list" width="100%">
						<tbody>
							...
							<tr height="30px">
								...
								<td><input name="xhCarMessage.businessInsurance" readonly="readonly" format="yyyy-MM-dd" type="text" size="27" value="${xhCarLoanApply.xhCarMessage.businessInsurance}" class="date required" maxlength="22" /> <a
									class="inputDateButton" href="javascript：;">选择</a></td>
								<td><label>车年检情况：</label></td>
								<td><input name="xhCarMessage.inspection" readonly="readonly" format="yyyy-MM-dd" type="text" size="27" value="${xhCarLoanApply.xhCarMessage.inspection}" class="date required" maxlength="22" /> <a
									class="inputDateButton" href="javascript：;">选择</a></td>
							</tr>
							<tr height="30px">
								<td><label>出厂日期：</label></td>
								<td><input name="xhCarMessage.madeTime" readonly="readonly" format="yyyy-MM-dd" type="text" size="27" value="${xhCarLoanApply.xhCarMessage.madeTime}" class="date required" maxlength="22" /> <a
									class="inputDateButton" href="javascript：;">选择</a></td>
								<td><label>交强险：</label></td>
								<td><input name="xhCarMessage.trafficInsurance" readonly="readonly" format="yyyy-MM-dd" type="text" size="27" value="${xhCarLoanApply.xhCarMessage.trafficInsurance}" class="date required" maxlength="22" /> <a
									class="inputDateButton" href="javascript：;">选择</a></td>
							</tr>
							<tr height="30px">
								<td><label>登记日期：</label></td>
								<td><input name="xhCarMessage.registerTime" readonly="readonly" type="text" format="yyyy-MM-dd" size="27" value="${xhCarLoanApply.xhCarMessage.registerTime}" class="date required" maxlength="22" /> <a
									class="inputDateButton" href="javascript：;">选择</a></td>
							...
							<tr height="30px">
								...
								<td><input name="xhCarMessage.plate" id="plate" type="text" size="30" value="${xhCarLoanApply.xhCarMessage.plate}" class="required" maxlength="22" onblur = "isCPHM()"/>
									(注：格式为京A12345)
								</td>
							</tr>
							 <tr height="30px">
					...
					<table class="list" width="100%">
						<tbody>
							<tr height="30px">
								...
								<td><input name="jkLoanQuota" type="text" size="30" value="${xhCarLoanApply.jkLoanQuota}" class="required number" /></td>
								<td><label>申请日期：</label></td>
								<td><input name="jkLoanDate" format="yyyy-MM-dd" type="text" size="15" readonly="readonly" value="${xhCarLoanApply.jkLoanDate}" class="date required"/> <a
									class="inputDateButton" href="javascript：;">选择</a><td>
							</tr>
							<tr height="30px">
								<td><label>申请借款期限：</label></td>
								<td><sen:selectRadio name="jkCycle" coding="carCycle" value="${xhCarLoanApply.jkCycle }" clazz="required"/></td>
				...
				<div>
					<table class="list" width="100%">
						...
						<tr height="30px">
							...
							<td><input name="" type="text" readonly="readonly" size="20" value="${staffname}" class="required" /> <input name="employeeService.id" size="20"
								value="${staffid}" type="hidden" /></td>
							<td><label>管辖城市：</label>
							</td>
