...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="${ctx }/xhCarLoanApply/listXhCarLoanApplyAudit/${type}" method="post">
	<div class="searchBar">
		...
		<tbody>
			...
			<tr target="sid_user" rel="${user.ID}">
				...
				<td>
		            ...
		            <c:choose>
		               <c:when test="${type =='first' }">
			            <div class="buttonActive">
							<div class="buttonContent">
								<a title="车借申请初审" target="navTab" href="${ctx }/xhCarAudit/carLoanApplyAudit/${user.ID}" >初审</a>
							</div>
			            </div>
			            </c:when>
			             <c:when test="${type =='second' }">
			            <div class="buttonActive">
							<div class="buttonContent">
								<a title="车借申请复审" target="navTab" href="${ctx }/xhCarAudit/carLoanApplySecondAudit/${user.ID}">复审</a>
							</div>
			            </div>
			            </c:when>
			             <c:when test="${type =='final' }">
			            <div class="buttonActive">
							<div class="buttonContent">
								<a title="车借申请终审" target="navTab" href="${ctx }/xhCarAudit/carLoanApplyLastAudit/${user.ID}">终审</a>
							</div>
			            </div>
			            </c:when>
		            </c:choose>
