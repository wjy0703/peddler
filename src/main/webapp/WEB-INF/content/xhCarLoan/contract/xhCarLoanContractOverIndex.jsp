...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="${ctx }/xhCarLoanContract/listXhCarLoanContractOver" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<table class="table" width="100%" layoutH="108">
		...
		<tbody>
			<c:forEach items="${xhCarLoanContract}" var="user" varStatus="st">
			<tr target="sid_user" rel="${user.ID}">
				...
				<td>
		         ...
		         <div class="buttonActive">
					<div class="buttonContent">
						<a title="查看已制作合同信息" target="navTab" href="${ctx }/xhCarLoanContract/editXhCarLoanContractLook/${user.ID}" >查看</a>
					</div>
		        </div>	
		        
		         <div class="buttonActive">
					<div class="buttonContent">
						<a title="协议查看" target="navTab" href="${ctx }/xhCarLoanContract/queryAgaee/${user.ID}" >协议查看</a>
					</div>
		        </div>	
