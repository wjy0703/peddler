						...
						<table class="list" width="100%">
							<tbody>
								...
								<tr height="30px">
									...
									<td><label>审核金额:</label> 
										<input name="creditAmount" id="creditAmount" readonly="readonly" type="text" size="30" value="${xhCarAudit.creditAmount}" />元
									</td>
								</tr>
							</tbody>
						</table>
...
function setMoney(){
	var jkLoanQuota = $("#creditAmount").val();
	//合同金额
	...
	//合同金额
	$("#contractMoney").val(jkLoanQuota-interest);
}
setDkll();
setMoney();
*/
