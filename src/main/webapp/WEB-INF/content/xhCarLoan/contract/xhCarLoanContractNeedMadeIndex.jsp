...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="${ctx }/xhCarLoanContract/listXhCarLoanContractNeedMade" method="post">
	<div class="searchBar">
		...
		<tbody>
			...
			<tr target="sid_user" rel="${user.ID}">
				...
				<td>
		         ...
		         <div class="buttonActive">
					<div class="buttonContent">
						<a title="合同制作" target="navTab" href="${ctx }/xhCarLoanContract/xhCarLoanContractNeedMade/${user.ID}" >合同制作</a>
					</div>
		        </div>	
