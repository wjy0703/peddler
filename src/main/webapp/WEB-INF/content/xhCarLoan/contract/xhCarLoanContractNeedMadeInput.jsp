...
<div class="pageContent">
	<form method="post" action="${ctx}/xhCarLoanContract/saveXhCarLoanContractNeedMade" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
		...
		<div class="panel" align="center">
			...
			<div class="panel" align="center">
				...
				<td>
					<label>合同签订日期：</label>
					<input name="qdrq" type="text" size="27" value="${xhCarLoanContract.qdrq}"  class="date"  format="yyyy-MM-dd" readonly="readonly"/>
