...
<div class="panel">
	...
	<div class="pageContent">
		<form method="post" id="jkhtform" name="jkhtform"
			action="${ctx}/xhJkht/saveJksqFuYi"
...
<%-- <p>
				...
				<table>
					<tr>
						<td><label>复议申请描述：</label><textarea id="fysqms" name="backup08" class="required" rows="8" cols="100" ></textarea></td>
					</tr>
				</table>
				...
				<table>
					<tr>
						<td><label>复议结果描述：</label><textarea rows="8" cols="100"></textarea></td>
					</tr>
				</table>
				...
				<table>
					<tr>
						<td><label>是否变更审批结果：</label>
							<input class="yesOrNo" type="radio" name="yesOrNo" value="1" />结果变更
							<input class="yesOrNo" type="radio" name="yesOrNo" value="0" />维持原判
						</td>
					</tr>
				</table>
				</c:if> --%>
