...
<form rel="pagerForm" onsubmit="return navTabSearch(this);"
		action="${ctx }/xhJkht/listJksq/51" method="post">
				<div class="searchBar">
			<table>
				<tr>
					<td><label>客户姓名:</label> 
...
</div>--> <!--<div id="allOption[${jksq.ID}]" style="display:block">-->
						...
						<div class="buttonActive">
							<div class="buttonContent">
								<a title="合同制作" href="${ctx}/xhJkht/queryAgaee/${jksq.ID}"
									...
									<button type="submit">协议查看</button>
								</a>
							</div>
						</div>
						...
						<div class="buttonActive">
							<div class="buttonContent">
								<a title="审批" target="navTab"
									href="${ctx }/xhJkht/auditXhJkht/${jksq.ID}" target="navTab"
									mask="true">
