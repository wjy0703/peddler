...
<div class="panel">
	...
	<div class="pageContent">
		<form method="post" id="jkhtform" name="jkhtform"
			action="${ctx}/xhJkht/madeXhJkhtSave" class="pageForm required-validate"
			...
			<td><label>借款人姓名：</label> <input name="jkrxm" type="text" size="30"
						...
						readonly /></td>
			<td><label>身份证号：</label> <input name="jkrxm" type="text" size="30"
			...
			<td><label>联系电话：</label> <input name="jkrxm" type="text" size="30"
				...
				<table>
					<td style="color: red"><label>借款利率%：</label> 
						<select   class="combox" id="dkll" name="dkll" onchange="f(this.value)">
...
type="text"
			...
			<td>
				<label>状态:</label>
				<input name="state" type="text" size="30" value="${xhJkht.state}" class="required" 
			...
			-->
					...
					<tr>
						<td><label>出借人*：</label> <input type="hidden"
							class="textInput" name="middleMan.id" size="10" 
