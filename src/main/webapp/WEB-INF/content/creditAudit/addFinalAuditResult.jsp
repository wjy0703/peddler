...
<!--
	function Convert(money) {
		var money = document.getElementById(creditAmount).value;
		var s = money; //获取小数型数据
		s += "";
		if (s.indexOf(".") == -1)
...
<div class="panel">
	...
	<div class="pageContent" width="100%">
		...
		<form method="post"
			...
			<input type="hidden" name="creditType" value="3" />
			...
			<div class="pageFormContent" layoutH="56">
				<div class="panelBar">
					<ul class="toolBar">
						...
						<li><a class="icon"
							...
							height="350"><span>查看初审结果</span></a></li>

						<li class="line">line</li>
						<li><a class="icon"
							href="${ctx}/loan/listFirstAuditHistory/${loanApplyId}/2"
							target="dialog" rel="dlg_page" title="查看复审结果" width="800"
							height="350"><span>查看复审结果</span></a></li>
					</ul>
				</div>
				...
				<dl class="nowrap">
					<dt>终审意见：</dt>
					<dd>
						<textarea name="creditAuditReport" rows="15" class="required"
							style="width: 93%; height: 70">${xhCreditAudit.creditAuditReport}</textarea>
					</dd>
				</dl>



				<label>终审结果：</label> <input type="radio" name="creditResult"
					id="creditResult1" value="1"
					onclick="return creditResult1Clicked();"> 终审通过 <input
					type="radio" name="creditResult" id="creditResult1" value="2"
					onclick="return creditResult1Clicked();"> 终审通过 (通知门店补充材料) <input
					type="radio" name="creditResult" id="creditResult4" value="4"
					onclick="return creditResult4Clicked();" />终审通过(追加共借人) <input
					type="radio" name="creditResult" id="creditResult3" value="3"
					onclick="return creditResult3Clicked();" />退回上一步 <input
					type="radio" name="creditResult" id="creditResult0" value="0"
					onclick="return creditResult0Clicked();"> 终审拒绝 <input
				...
				<dl class="nowrap" id="creditRefuseReason" style="display: none">
					...
					<dd>
						<textarea name="creditRefuseReason" rows="7"
							id="creditRefuseReason1" style="width: 93%; height: 70">${xhCreditAudit.creditRefuseReason}</textarea>
					</dd>
				</dl>
