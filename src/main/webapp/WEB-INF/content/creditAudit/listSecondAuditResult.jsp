...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);"
		action="${ctx }/loan/listCreditAuditResultByType/2" method="post">
		<div class="searchBar">
			...
			<table  width="100%">
				...
				<tr>
					...
					<td><label>复审结果:</label> <select name="filter_creditResult" class="combox">
		...
		<tbody>
			<c:forEach items="${page.result}" var="user" varStatus="st">
				<tr target="sid_user" rel="${user.id}">
					...
					| <a href="${ctx }/xhBorrowscore/jksqGrade/${user.loanApply.id}?look=1"
