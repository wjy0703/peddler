			...
			<div class="pageFormContent" layoutH="56">
				...
				<p>
					<label>批借金额(￥)：</label> <input name="pdje" type="text" size="30"
						value="${xhIpcConstract.pdje}" class="required" maxlength="22" />
				</p>


				<p>
					<label>放款金额(￥)：</label> <input name="fkje" type="text" size="30"
						value="${xhIpcConstract.fkje}" class="required" maxlength="22" />
				</p>
				<p>
					<label>还款期数(月)：</label> <input name="hkqs" type="text" size="30"
						value="${xhIpcConstract.hkqs}" class="required" maxlength="22" />
				</p>
				<p>
					<label>综合费率(%)：</label> <input name="yzhfl" type="text" size="30"
						value="${xhIpcConstract.yzhfl}" class="required" maxlength="22" />
				</p>

				<p>
					<label>借款利率(%)：</label> <input name="dkll" type="text" size="30"
						value="${xhIpcConstract.dkll}" class="required" maxlength="22" />
				</p>


				<p>
					<label>剩余利率(%)：</label> <input name="syll" type="text" size="30"
						value="${xhIpcConstract.syll}" class="required" maxlength="22" />
				</p>
				<p>
					<label>剩余金额(￥)：</label> <input name="syje" type="text" size="30"
						value="${xhIpcConstract.syje}" class="required" maxlength="22" />
				</p>


				<p>
					<label>服务费(￥)：</label> <input name="fwf" type="text" size="30"
						value="${xhIpcConstract.fwf}" class="required" maxlength="22" />
				</p>

				<p>
					<label>管理费(￥)：</label> <input name="zhglf" type="text" size="30"
						value="${xhIpcConstract.zhglf}" class="required" maxlength="22" />
				</p>

				<p>
					<label>信审费(￥)：</label> <input name="xyshf" type="text" size="30"
						value="${xhIpcConstract.xyshf}" class="required" maxlength="22" />
				</p>

				<p>
					<label>咨询费(￥)：</label> <input name="zxf" type="text" size="30"
						value="${xhIpcConstract.zxf}" class="required" maxlength="22" />
				</p>
				<p>
					<label>合同金额(￥)：</label> <input name="htje" type="text" size="30"
						value="${xhIpcConstract.htje}" class="required" maxlength="22" />
				</p>
				...
				<p>
					<label>月本金金额(￥)：</label> <input name="ybjje" type="text" size="30"
						value="${xhIpcConstract.ybjje}" class="required" maxlength="22" />
				</p>
				<p>
					<label>月利息金额(￥)：</label> <input name="ylxje" type="text" size="30"
						value="${xhIpcConstract.ylxje}" class="required" maxlength="22" />
				</p>

				<p>
					<label>月还款金额(￥)：</label> <input name="yhkje" type="text" size="30"
						value="${xhIpcConstract.yhkje}" class="required" maxlength="22" />
				</p>
			...
			<p>
				...
				<p>
					<label>借款合同编号：</label> <input name="jkhtbm" type="text" size="30"
						value="${xhIpcConstract.jkhtbm}" class="required" maxlength="20" />
				</p>
				...
				<p>
				    ...
				    <input name="auditDate" type="text" size="30" value="<fmt:formatDate value="${xhIpcConstract.auditDate}" pattern="yyyy-MM-hh"/>" class="required date" maxlength="30" />
					<a class="inputDateButton" href="#">选择</a>
				</p>
				<p>
					<label>审核意见：</label> 
					<input name="auditIdea" type="text" size="30"  value="${xhIpcConstract.auditIdea}" class="required" maxlength="512" />
				</p>
				<p>
					<label>审核人：</label> 
					<input name="auditPerson" type="text" size="30" 	value="${xhIpcConstract.auditPerson}" class="required" maxlength="32" />
				</p>
				<div class="divider"></div>
				<p>
					<label>签约确认审核时间：</label> 
					<input name="auditQzqrDate" type="text" size="30" value="<fmt:formatDate value="${xhIpcConstract.auditQzqrDate}" pattern="yyyy-MM-hh"/>" class="required date" maxlength="30" />
						<a class="inputDateButton" href="#">选择</a>
				</p>
				<p>
