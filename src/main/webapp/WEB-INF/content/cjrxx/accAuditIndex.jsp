...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);"
		action="${ctx }/cjrxx/listAccAuditCjr" method="post">
			...
			<table>
				<tr>
					...
					<td><label>CRM城市：</label> <select class="combox"
						name="filter_crmprovince" ref="combox_AccAuditcjrcrmcity"
...
<th width="80" orderField="cjrxm" >客户名</th>
				<th width="80">省份</th>
				<th width="80">城市</th>
				<th width="80">团队经理</th>
				<th width="80">理财经理</th>
			...
			<c:forEach items="${listCjrxx}" var="user" varStatus="st">
				<tr target="sid_user" rel="${user.ID}">
		            ...
		            <div class="buttonActive">
				        <div class="buttonContent">
						<a title="审批"
						target="navTab" href="${ctx }/cjrxx/accAuditCjrxx/${user.ID}">审批</a>
						</div>
		            </div>
		            </c:if>
					</td>
