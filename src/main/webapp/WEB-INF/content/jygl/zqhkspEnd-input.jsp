...
<div class="pageContent">
	...
	<form method="post" action="${ctx}/jygl/saveZqtjhkspEnd"
		...
		<div class="pageFormContent" layoutH="56">
			...
			<p>
				<label>出借协议编号：</label> <input name="tzxybh" type="text" size="30"
					value="${value.TZSQBH}" readonly="readonly" />
			</p>
			<p>
				<label>出借人姓名：</label> <input name="cjrxm" type="text" size="30"
					value="${value.CJRXM }" disabled="disabled" />
			</p>
			<p>
				<label>所属城市：</label> <input name="sscs" type="text" size="30"
					value="${value.PRONAME }" disabled="disabled" />
			</p>
			<p>
				<label>出借资金状态：</label> <input name="tzzjzt" type="text" size="30"
					value="首期" disabled="disabled" />
			</p>
			<p>
				<label>计划出借日期：</label> <input name="jhtzrq" type="text" size="30"
					value="${value.JHTZRQ}" disabled="disabled" />
			</p>
			<p>
				<label>计划划扣日期：</label> <input name="jhhkrq" type="text" size="30"
					value="${value.JHHKRQ}" disabled="disabled" />
			</p>
			<p>
				<label>计划出借金额(￥)：</label> <input name="jhtzje" type="text" size="30"
					value="<fmt:formatNumber
							value="${value.MONEY}" pattern="#,#00.00" />" disabled="disabled" />
			</p>
			<p>
				<label>实际划扣日期:</label>
				<input type="text" name="sjhkrq"
							class="required date" pattern="yyyy-MM-dd" value="${value.sjhkrq }"
			...
			<dl class="nowrap">
				<dt>划扣结果：</dt>
				<dd>
					<input type="radio" name="statedg" id="statedg" value="1" checked="checked" />确认划扣
