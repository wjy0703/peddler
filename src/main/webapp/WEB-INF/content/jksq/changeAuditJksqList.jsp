...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);"
		action="${ctx }/jksq/listChangeAuditJksq" method="post">
		<div class="searchBar">
			<table>
				<tr>
					<td><label>客户姓名:</label> 
...
<div class="pageContent">
	<table class="table" width="100%" layoutH="138" nowrapTD="false">
		...
		<tbody>
			<c:forEach items="${jksqChangeExam }" var="jksq" varStatus="st">
				<tr  target="sid_jksq" rel="${jksq.ID}">
					...
					<td>
						...
						<div class="buttonActive">
							<div class="buttonContent">
								<a href="${ctx }/jksq/jksqChangeExam/${jksq.ID}" rel="rel_jksqChangeExam"
										target="navTab" title="借款变更审批"><button type="submit">审批</button></a>
							</div>
						</div>
					</td>
				</tr>
