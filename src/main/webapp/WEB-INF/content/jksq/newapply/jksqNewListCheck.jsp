...
<div class="pageHeader">
	<form id="jksqListForm" name="jksqListForm" rel="pagerForm"
		...
		action="${ctx }/xhNewJksq/listJksqCheck" method="post">
	...
	<table class="table" width="100%" layoutH="138">
		...
		<tbody>
			...
			<%-- 		<td><sen:addressName id="${jksq.PROVINCE}"/></td> --%>
					...
					<td style="color: red; font-weight: bold">${jksq.STATE }
					...
					<td>${jksq.JK_CYCLE }</td>
					<td><sen:employeeName id="${jksq.TEAMNAMEID }" /></td>
					<td><sen:employeeName id="${jksq.SALENAMEID }" /></td>
			...
			|<a href="${ctx }/xhNewJksq/alwaysChange/${jksq.ID}" target="navTab"
