		...
		<div class="tabsContent" >
			<div>
				<form id="jksqChangeInputForm" name="jksqChangeInputForm" method="post"
					action="${ctx}/xhNewJksq/saveNewjksqChange" class="pageForm required-validate"
					onsubmit="return validateCallback(this, navTabAjaxDone);">
					<div class="pageFormContent" layoutH="56">
						<input type="hidden" name="jksqId" value="${jksq.id }" title="变更申请ID" />
						<input type="hidden" name="id" value="" />
						<div class="panel" align="center"><h1>客户基本信息</h1></div>
						<table nowrapTD="false">
							<tr>
								<td colspan="2"><label>借款人姓名:</label> 
						...
						<table border="0" bordercolor="red" width="98%">
							<tr>
								<td><label>系统名称：</label> 
									<input type="text" id="sysName" name="sysName"  size="30"  value="信和财富CHP平台"   readonly class="required"/> 
								</td>
								<td><label>系统模块：</label> 
									<input type="text" id="sysModule" name="sysModule"  size="30" value="借款申请" readonly class="required"/> 
								</td>
							</tr>
							<tr>
								<td><label>需求类型：</label> 
									<sen:selectRadio name="requirType" clazz="required"  coding="needType" split="&nbsp;&nbsp;&nbsp;&nbsp;" />
								</td>
							...
							<tr>
								<td colspan="3">
									<dl class="nowrap">
										<dt>修改原因：</dt>
										<dd>
											<textarea id="updateCause" name="updateCause" class="required" rows="4" style="width: 93%;" class="required"  maxlength="256"  alt="最多512个字符"></textarea>
							...
							<tr>
								<td colspan="3">
									<dl class="nowrap">
										<dt>修改内容描述(尽量详细)：</dt>
										<dd>
											<textarea id="commentInfo" name="commentInfo" class="required" rows="4" style="width: 93%;" class="required" maxlength="256"></textarea>
										</dd>
									</dl>
								</td>
							</tr>
