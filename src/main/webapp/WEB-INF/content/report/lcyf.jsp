		...
		<div class="searchBar">
			<table>
				...
				<tr>
					...
					<td><label>从日期:</label> <input type="text" name="startjjrq" class="date" pattern="yyyy-MM-dd" value="" size="20" /></td>
				    <td><label>到日期:</label> <input type="text" name="endjjrq" class="date" pattern="yyyy-MM-dd" value="" size="20" /></td>
	...
	<table class="table" width="200%" layoutH="138">
		<thead>
			<tr>
				...
				<th width="80">理财产品</th>
				<th width="80">出借人手机号</th>
				<th width="80">出借人银行卡号</th>
				<th width="80">银行卡开户行</th>
				<th width="80">出借人所在省份</th>
				<th width="80">本息偿还方式</th>
				<th width="80">某月已付本金</th>
				<th width="80">某月应付本金</th>
				<th width="80">某月应付利息</th>
				<th width="80">支付时间</th>
				<th width="80">剩余本金</th>
				<th width="80">剩余应记利息</th>
				<th width="80">剩余期数</th>
			</tr>
		</thead>
