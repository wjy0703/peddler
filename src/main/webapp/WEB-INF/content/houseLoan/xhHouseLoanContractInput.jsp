...
<div class="panel">
	<div class="pageContent">
		<form method="post"
			...
			<input type="hidden" name="id" value="${xhHouseLoanContract.id}" />
			<input type="hidden" name="apply_id" value="${xhHouseLoanApply.id}" />
			<input type="hidden" name="auditInfo_id"
				value="${xhHouseLoanAuditInfo.id}" />
			...
			<div class="pageFormContent" layoutH="56">
				...
				<p>
					<label>客户姓名：</label> <input name="loanerName" type="text" size="30"
						value="${xhHouseLoanApply.loanerName}" class="" maxlength="22"
						readonly />
				</p>
				<p>
					<label>身份证号：</label> <input name="loanerIdNumber" type="text"
						size="30" value="${xhHouseLoanApply.loanerIdNumber}" class=""
						maxlength="22" readonly />
				</p>
				<p>
					<label>现住址：</label> <input name="loanSrcAddress" type="text"
						size="30" value="${xhHouseLoanApply.loanSrcAddress}" class=""
						maxlength="22" readonly />
				</p>
				<p>
					<label>手机号：</label> <input name="telephone" type="text" size="30"
						value="${xhHouseLoanApply.telephone}" class="" maxlength="22"
						readonly />
				</p>
				<p>
					<label>开户行：</label> <input name="bankOpen" type="text" size="30"
						value="${xhHouseLoanApply.bankOpen}" class="" maxlength="22"
						readonly />
				</p>
				<p>
					<label>银行卡号：</label> <input name="bankNum" type="text" size="30"
						value="${xhHouseLoanApply.bankNum}" class="" maxlength="22"
						readonly />
				</p>
				...
				<p>
					<label>产权证号：</label> <input name="houseRightNum" type="text"
						size="30" value="${xhHouseLoanApply.houseRightNum}" class=""
						maxlength="22" readonly />
				</p>
				<p>
					<label>抵押房地址：</label> <input name="houseAddress" type="text"
						size="30" value="${xhHouseLoanApply.houseAddress}" class=""
						maxlength="22" readonly />
				</p>
				<p>
					<label>建筑面积：</label> <input name="houseArea" type="text" size="30"
						value="${xhHouseLoanApply.houseArea}" class="" maxlength="22"
						readonly />
				</p>
				...
				<p>
					<label>房屋评估价值(元)：</label> <input name="houseEvaluateValue"
						type="text" size="30"
						value="${xhHouseLoanAuditInfo.houseEvaluateValue}" class=""
						maxlength="22" />
				</p>
				...
				<p>
					<label>批借(合同)金额(元)：</label> <input name="contractMoney" type="text"
						size="30" value="${xhHouseLoanAuditInfo.contractMoney}" class=""
						maxlength="22" />
				</p>

				<p>
					<label>借款期数(月)：</label> <input name="loanMonth" type="text"
						size="30" value="${xhHouseLoanAuditInfo.loanMonth}" class=""
						maxlength="22" />
				</p>
				<div class="divider"></div>
				<p>
					<label>信访费(元)：</label> <input name="creditVisitFee" type="text"
						size="30" value="0.00" class="" maxlength="22" />
				</p>
				<div class="divider"></div>
				<p>
					<label>综合费率(%)：</label> <input name="allFeeRate" type="text"
						size="30" value="${xhHouseLoanAuditInfo.allFeeRate}" class=""
						maxlength="22" />
				</p>

				<p>
					<label>月利率(%)：</label> <input name="monthRate" type="text"
						size="30" value="1.0" class="" maxlength="22" />
				</p>
				<p>
					<label>服务费率(%)：</label> <input name="serviceFeeRate" type="text"
						size="30" value="${xhHouseLoanAuditInfo.serviceFeeRate}" class=""
						maxlength="22" />
				</p>
				<div class="divider"></div>
				...
				<p>
					<label>签约日期：</label> <input name="contractDate" type="text"
						size="30"
						value='<fmt:formatDate value="${xhHouseLoanAuditInfo.signContractDate}" pattern="yyyy-MM-dd" />'
				...
				<p>
					...
					<!-- <input name="loanMonth" type="text" size="30"
						value="${xhHouseLoanAuditInfo.chargeType}" class=""
						maxlength="22" /> -->
				</p>
				...
				<p>
					<label>合同编号：</label> <input name="contractNum" type="text"
						size="30" value="${xhHouseLoanContract.contractNum}" class=""
						maxlength="50" />
				</p>
				...
				<p>
					<label>出借人：</label> <input type="hidden" class="textInput"
						...
						value="${xhHouseLoanContract.middleMan.id}" class=""
						maxlength="22" /> <input type="text" class="textInput"
						name="middleMan.middleManName" size="10"
						value="${xhHouseLoanContract.middleMan.middleManName}" class=""
						maxlength="22" /> <a class="btnLook"
						href="${ctx}/jygl/listMiddleMan" lookupGroup="middleMan">请选择出借人</a>
				</p>
				<p>
					<!--  	<label>备注：</label> <input name="remark" type="text" size="30"
						value="${xhHouseLoanContract.remark}" class=""
						maxlength="200" />
				</p>-->
			</div>
			<div class="formBar">
				<ul>
					<c:if test='${xhHouseLoanContract.state="1"}'>
