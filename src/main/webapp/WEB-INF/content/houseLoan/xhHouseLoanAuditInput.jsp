...
<div class="panel">
	<div class="pageContent">
		<form method="post"
			action="${ctx}/xhHouseLoanAudit/saveXhHouseLoanAudit"
			class="pageForm required-validate"
			onsubmit="return validateCallback(this, navTabAjaxDone);">
			<input type="hidden" name="id" value="${xhHouseLoanAudit.id}" />
			<input type="hidden" name="house_apply_id" value="${xhHouseLoanApply.id}" />
			
			<div class="pageFormContent" layoutH="56">
			
				<p>
					<label>客户姓名：</label> <input name="loanerName" type="text"
						size="30" value="${xhHouseLoanApply.loanerName}" class=""
						maxlength="50" readonly />
				</p>
				<p>
					<label>申请金额：</label> <input name="loanLoanAmount" type="text"
						size="30" value="${xhHouseLoanApply.loanLoanAmount}" class=""
						maxlength="50" readonly />
				</p>
				<p>
					<label>用款目的：</label> <input name="loanReason" type="text" size="30"
						value="${xhHouseLoanApply.loanUse}" class=""
						maxlength="50" readonly/>
				</p>
				<p>
					<label>还款来源：</label> <input name="repaySource" type="text"
						size="30" value="${xhHouseLoanApply.backMoneyType}"
						class="" maxlength="50" readonly/>
				</p>
				<dl class="nowrap">
					<dt>房屋详细地址：</dt>
					<dd>
						<textarea name="hjadress" style="width: 100%;" readonly>${xhHouseLoanApply.houseAddress}</textarea>
					</dd>
				</dl>
				...
				<dl class="nowrap">
					<dt>其它审核信息：</dt>
					<dd>
						<textarea name="otherAuditInfo" style="width: 100%;">${xhHouseLoanAudit.otherAuditInfo}</textarea>
					</dd>
				</dl>
				<div class="divider"></div>
...
<div class="divider"></div>
				...
				<dl class="nowrap">
					<dt>审核意见：</dt>
					<dd>
						<textarea name="hjadress" style="width: 100%;">${xhHouseLoanAudit.aduitState}</textarea>
					</dd>
				</dl>
				<p>
					<label>审核结果：</label> <input name="aduitState" type="radio"
						size="30" value="${xhHouseLoanAudit.aduitState}" class=""
						maxlength="20" />审核通过 <input name="aduitState" type="radio"
						size="30" value="${xhHouseLoanAudit.aduitState}" class=""
						maxlength="20" />审核拒绝
				</p>-->
			</div>
